...
| Skill | Purpose |
| --- | --- |
| [`fowler-refactoring`](skills/fowler-refactoring/) | Refactor existing code through small, Fowler-grounded, behavior-preserving transformations. |
...
```text
Use $fowler-refactoring to improve a module through small, verified changes without changing observable behavior.
