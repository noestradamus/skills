...
| Skill | Purpose |
| --- | --- |
| [`fowler-refactoring`](skills/fowler-refactoring/) | Refactor existing code in small, Fowler-grounded steps while preserving observable behavior. |
...
```text
Use $fowler-refactoring to improve this module's design without changing observable behavior.
